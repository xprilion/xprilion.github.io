...
This blog is a read-along for the repository [xprilion/ollama-cloud-run](https://github.com/xprilion/ollama-cloud-run/) which shows how to deploy various models using the Ollama API on Cloud Run, to run inference using CPU only on a serverless platform - incurring bills only when you use them.
...
| --- | --- | --- |
| codegemma | 2b | [codegemma/2b](https://github.com/xprilion/ollama-cloud-run/tree/main/codegemma/2b) |
| codegemma | 7b | [codegemma/7b](https://github.com/xprilion/ollama-cloud-run/tree/main/codegemma/7b) |
| gemma | 2b | [gemma/2b](https://github.com/xprilion/ollama-cloud-run/tree/main/gemma/2b) |
| gemma | 7b | [gemma/7b](https://github.com/xprilion/ollama-cloud-run/tree/main/gemma/7b) |
| gemma2 | 9b | [gemma2/9b](https://github.com/xprilion/ollama-cloud-run/tree/main/gemma2/9b) |
| llama3 | 8b | [llama3/8b](https://github.com/xprilion/ollama-cloud-run/tree/main/llama3/8b) |
| llava | 7b | [llava/7b](https://github.com/xprilion/ollama-cloud-run/tree/main/llava/7b) |
| mistral | 7b | [mistral/7b](https://github.com/xprilion/ollama-cloud-run/tree/main/mistral/7b) |
| phi3 | 3.8b | [phi3/3.8b](https://github.com/xprilion/ollama-cloud-run/tree/main/phi3/3.8b) |
| qwen2 | 0.5b | [qwen2/0.5b](https://github.com/xprilion/ollama-cloud-run/tree/main/qwen2/0.5b) |
